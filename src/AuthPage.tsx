      ...
      >
        <div
          style={{
            ...
            inset: 0,
            background:
              "radial-gradient(circle at 20% 20%, rgba(139,92,246,0.18), transparent 22%), radial-gradient(circle at 80% 30%, rgba(34,211,238,0.10), transparent 18%), radial-gradient(circle at 50% 80%, rgba(34,197,94,0.08), transparent 20%)",
            pointerEvents: "none",
          }}
        />
            ...
            >
              <div
                style={{
                  ...
                  fontSize: "36px",
                  boxShadow:
                    "0 16px 40px rgba(124,58,237,0.35), inset 0 1px 0 rgba(255,255,255,0.18)",
                  marginBottom: "20px",
                }}
              >
                📈
            ...
            >
              ...
              <span
                style={{
                  display: "block",
                  background:
                    "linear-gradient(135deg, #ffffff 0%, #c4b5fd 35%, #67e8f9 100%)",
      ...
      >
        <div
          ...
          style={{
            ...
            padding: "38px 36px",
            background:
              "linear-gradient(135deg, rgba(17,20,34,0.96), rgba(24,18,43,0.94))",
          }}
        >
          <div
            style={{
          ...
          >
            Tu progreso, tus trades y tu disciplina, sincronizados en la nube.
          </div>
        </div>
      </div>
    </div>
